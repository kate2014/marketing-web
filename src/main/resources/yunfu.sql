...
CREATE TABLE `booking` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=159 DEFAULT CHARSET=utf8 COMMENT='预订表';
...
) ENGINE=InnoDB AUTO_INCREMENT=27 DEFAULT CHARSET=utf8 COMMENT='仅为数据迁移暂定，后续按产品需求修改';
...
) ENGINE=InnoDB AUTO_INCREMENT=40 DEFAULT CHARSET=utf8 COMMENT='菜品属性表';
...
) ENGINE=InnoDB AUTO_INCREMENT=34 DEFAULT CHARSET=utf8 COMMENT='订单用户关联表';
...
) ENGINE=InnoDB AUTO_INCREMENT=248 DEFAULT CHARSET=utf8 COMMENT='角色权限关系表';

DROP TABLE IF EXISTS  `customer_search_rule`;
CREATE TABLE `customer_search_rule` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增主键',
  `consumption_main_day` int(11) DEFAULT NULL COMMENT '消费主力群',
  `consumption_main_amount` int(11) DEFAULT NULL COMMENT '消费主力群金额',
  `members_will_day` int(11) DEFAULT NULL COMMENT '将流失会员',
  `members_will_amount` int(11) DEFAULT NULL COMMENT '将流失会员金额',
  `members_loss_day` int(11) DEFAULT NULL COMMENT '已流失会员',
  `members_loss_amount` int(11) DEFAULT NULL COMMENT '已流失会员天数',
  `members_new_interval_day` int(11) DEFAULT NULL COMMENT '新会员 多少天为新会员',
  `members_birthday_before_day` int(11) DEFAULT NULL COMMENT '将过生日会员',
  `members_anniversary_before_day` int(20) DEFAULT NULL COMMENT '满周年会员',
...
) ENGINE=InnoDB AUTO_INCREMENT=47 DEFAULT CHARSET=utf8 COMMENT='门店菜品';
...
CREATE TABLE `customer_marketing_together` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_server_time` (`server_create_time`,`server_update_time`)
) ENGINE=InnoDB AUTO_INCREMENT=63 DEFAULT CHARSET=utf8 COMMENT='会员关联同行特惠';
...
) ENGINE=InnoDB AUTO_INCREMENT=190 DEFAULT CHARSET=utf8 COMMENT='桌台表';
...
CREATE TABLE `cut_down_marketing` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_server_time` (`server_create_time`,`server_update_time`)
) ENGINE=InnoDB AUTO_INCREMENT=2026 DEFAULT CHARSET=utf8 COMMENT='砍价活动';
...
CREATE TABLE `talent_role` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=32 DEFAULT CHARSET=utf8 COMMENT='不同角色对于的人效方案';
...
CREATE TABLE `push_plan_new_dish` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_server_time` (`server_create_time`,`server_update_time`)
) ENGINE=InnoDB AUTO_INCREMENT=2077 DEFAULT CHARSET=utf8 COMMENT='新品推送方案';
...
CREATE TABLE `table_area` (
  ...
  `server_create_time` timestamp(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) COMMENT '创建时间',
...
CREATE TABLE `talent_rule` (
  ...
  `server_update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '服务器更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=25 DEFAULT CHARSET=utf8 COMMENT='人效规则算法';
...
CREATE TABLE `customer_score_rule` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_server_time` (`server_create_time`,`server_update_time`)
) ENGINE=InnoDB AUTO_INCREMENT=2023 DEFAULT CHARSET=utf8 COMMENT='会员等级积分成长规则、积分使用规则';
...
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COMMENT='会员次卡消费表';
...
CREATE TABLE `push_plan_activity` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_server_time` (`server_create_time`,`server_update_time`)
) ENGINE=InnoDB AUTO_INCREMENT=2054 DEFAULT CHARSET=utf8 COMMENT='活动推送活动方案';
...
) ENGINE=InnoDB AUTO_INCREMENT=366 DEFAULT CHARSET=utf8 COMMENT='付款主单\r\n主单及其子单的金额在退货时都取反';
...
CREATE TABLE `marketing_put_on` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_server_time` (`server_create_time`,`server_update_time`)
) ENGINE=InnoDB AUTO_INCREMENT=2032 DEFAULT CHARSET=utf8 COMMENT='优惠券投放';
...
) ENGINE=InnoDB AUTO_INCREMENT=59660 DEFAULT CHARSET=utf8 COMMENT='品牌表';
...
CREATE TABLE `customer_marketing_expanded` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_server_time` (`server_create_time`,`server_update_time`)
) ENGINE=InnoDB AUTO_INCREMENT=2060 DEFAULT CHARSET=utf8 COMMENT='会员关联推广回馈';
...
) ENGINE=InnoDB AUTO_INCREMENT=71 DEFAULT CHARSET=utf8 COMMENT='支付明细扩展表';
...
) ENGINE=InnoDB AUTO_INCREMENT=137 DEFAULT CHARSET=utf8 COMMENT='优惠信息';
...
) ENGINE=InnoDB AUTO_INCREMENT=368 DEFAULT CHARSET=utf8 COMMENT='交易的顾客信息';
...
CREATE TABLE `push_message_customer` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_server_time` (`server_create_time`,`server_update_time`)
) ENGINE=InnoDB AUTO_INCREMENT=2041 DEFAULT CHARSET=utf8 COMMENT='推送信息给顾客';
...
CREATE TABLE `customer_stored` (
  ...
  KEY `idx_server_time` (`server_create_time`,`server_update_time`)
) ENGINE=InnoDB AUTO_INCREMENT=2031 DEFAULT CHARSET=utf8 COMMENT='会员储值、储值消费记录表';
...
CREATE TABLE `cut_down_customer` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_server_time` (`server_create_time`,`server_update_time`)
) ENGINE=InnoDB AUTO_INCREMENT=2076 DEFAULT CHARSET=utf8 COMMENT='会员发起砍价记录';
...
CREATE TABLE `wx_trade_customer` (
  ...
  KEY `idx_brand_identy_server_update_time` (`brand_identy`,`server_update_time`),
  KEY `idx_shop_identy_status_flag_account` (`shop_identy`,`status_flag`)
) ENGINE=InnoDB AUTO_INCREMENT=62 DEFAULT CHARSET=utf8 COMMENT='微信小程序购买使用记录';
...
CREATE TABLE `commercial_pay_setting` (
  ...
  `wx_shop_id` varchar(32) NOT NULL COMMENT '小程序支付商户编号',
  `api_secret` varchar(32) NOT NULL COMMENT '小程序API支付秘钥',
  ...
  PRIMARY KEY (`id`),
  KEY `idx_server_time` (`server_create_time`,`server_update_time`)
) ENGINE=InnoDB AUTO_INCREMENT=2024 DEFAULT CHARSET=utf8 COMMENT='商户线上支付配置';
...
CREATE TABLE `collage_customer` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_server_time` (`server_create_time`,`server_update_time`)
) ENGINE=InnoDB AUTO_INCREMENT=2077 DEFAULT CHARSET=utf8 COMMENT='会员拼团记录';
...
CREATE TABLE `auth_role` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_brand_identy` (`brand_identy`)
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8 COMMENT='角色表 : 商户角色信息';
...
CREATE TABLE `customer_integral` (
  ...
  KEY `idx_shop_identy_status_flag_account` (`shop_identy`,`status_flag`),
  KEY `idx_server_time` (`server_create_time`,`server_update_time`)
) ENGINE=InnoDB AUTO_INCREMENT=2053 DEFAULT CHARSET=utf8 COMMENT='会员积分表';
...
) ENGINE=InnoDB AUTO_INCREMENT=66 DEFAULT CHARSET=utf8 COMMENT='菜品类型';
...
) ENGINE=InnoDB AUTO_INCREMENT=568 DEFAULT CHARSET=utf8 COMMENT='交易明细';
...
CREATE TABLE `attachment` (
  ...
  `server_update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '服务器更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=180 DEFAULT CHARSET=utf8 COMMENT='文件附件表（用于临时存储）';
...
CREATE TABLE `customer_level_rule` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_server_time` (`server_create_time`,`server_update_time`)
) ENGINE=InnoDB AUTO_INCREMENT=2030 DEFAULT CHARSET=utf8 COMMENT='会员等级积分表';
...
CREATE TABLE `customer_coupon` (
  ...
  KEY `idx_shop_identy_status_flag_account` (`shop_identy`,`status_flag`),
  KEY `idx_server_time` (`server_create_time`,`server_update_time`)
) ENGINE=InnoDB AUTO_INCREMENT=2108 DEFAULT CHARSET=utf8 COMMENT='会员优惠券关联表';
...
CREATE TABLE `coupon` (
  ...
  `dish_id` bigint(20) DEFAULT NULL COMMENT '品项id',
  `dish_name` varchar(20) DEFAULT NULL COMMENT '品项名称',
  `remark` varchar(40) DEFAULT NULL COMMENT '备注信息',
  ...
  KEY `idx_server_time` (`server_create_time`,`server_update_time`)
) ENGINE=InnoDB AUTO_INCREMENT=2098 DEFAULT CHARSET=utf8 COMMENT='优惠券';
...
CREATE TABLE `booking_trade_item_user` (
  ...
  `updator_name` varchar(32) DEFAULT NULL COMMENT '最后修改者姓名',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8 COMMENT='预定订单销售员与订单商品关系';
...
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=utf8 COMMENT='套餐';
...
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8 COMMENT='套餐内菜品分组 : dish_type表只能存在两个级别的分类';
...
CREATE TABLE `booking_trade_item` (
  ...
  KEY `idx_server_update_time` (`shop_identy`,`server_update_time`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=123 DEFAULT CHARSET=utf8 COMMENT='交易明细';
...
CREATE TABLE `cut_down_history` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_server_time` (`server_create_time`,`server_update_time`)
) ENGINE=InnoDB AUTO_INCREMENT=2059 DEFAULT CHARSET=utf8 COMMENT='砍价记录';
...
CREATE TABLE `expanded_commission` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_server_time` (`server_create_time`,`server_update_time`)
) ENGINE=InnoDB AUTO_INCREMENT=2050 DEFAULT CHARSET=utf8 COMMENT='推广提成';
...
) ENGINE=InnoDB AUTO_INCREMENT=341 DEFAULT CHARSET=utf8 COMMENT='付款明细';
...
) ENGINE=InnoDB AUTO_INCREMENT=579 DEFAULT CHARSET=utf8 COMMENT='交易记录主单（相当于ORDERS）。\n主单及其所有子单中的数量、金额在退货时都取反';
...
CREATE TABLE `customer_card_time` (
  ...
  KEY `idx_brand_identy_server_update_time` (`brand_identy`,`server_update_time`),
  KEY `idx_shop_identy_status_flag_account` (`shop_identy`,`status_flag`)
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=utf8 COMMENT='会员次卡表';
...
CREATE TABLE `collage_marketing` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_server_time` (`server_create_time`,`server_update_time`)
) ENGINE=InnoDB AUTO_INCREMENT=2026 DEFAULT CHARSET=utf8 COMMENT='拼团活动';
...
CREATE TABLE `customer` (
  ...
  KEY `idx_shop_identy_status_flag_account` (`brand_identy`,`shop_identy`,`status_flag`),
  KEY `idx_server_time` (`server_create_time`,`server_update_time`)
) ENGINE=InnoDB AUTO_INCREMENT=166 DEFAULT CHARSET=utf8 COMMENT='会员表';
