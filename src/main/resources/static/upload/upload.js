$(function () {
    $.fn.ajaxImageUpload = function(options){
        ...
        var ajaxUpload = function () {
            ...
            $.ajax({
                ...
                success:function(json){
                    ...
                    imageShow.attr('src', json.content.url);
                    imageShow.siblings('input').val(json.content.id);
        ...
        var createDeleteModal = function () {
            ...
            var deleteModal   = $("<aside class='delete-modal'><div class='modal-content'><p class='modal-tip'>您确定要删除吗？</p><p class='modal-btn'><span class='confirm-btn'>确定</span><span class='cancel-btn'>取消</span></p></div></aside>");
            // 创建删除模态框
        ...
        var createImageSection = function () {
            ...
            var imageInput   = $("<input class='" + inputName + "' name='" + inputName + "Array' value='' type='hidden'>");
            var imageZoom    = $("<div class='image-zoom'></div>");
            var imageDelete  = $("<div class='image-delete'></div>");

            imageBox.append(imageSection);
