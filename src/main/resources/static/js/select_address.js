var provinceList = [
    ...
    {name:'四川', cityList:[
            {name:'', areaList:['']},
            {name:'成都市', areaList:['', '市辖区','锦江区','青羊区','金牛区','武侯区','成华区','高新区','天府新区','龙泉驿区','青白江区','新都区','温江县','金堂县','双流县','郫县','大邑县','蒲江县','新津县','都江堰市','彭州市','邛崃市','崇州市']},
...
function chooseProvince(th){   //通过方法的调用来实现省 市之间的二级联动，th是我们设置的一个参数，方便下面进行使用，可以理解为province的一个元素（名字）
    var index = th.selectedIndex-1;   //此处selectedIndex的索引减1是因为我们在写<select><option>按钮时  “省”  占了一个索引，所以需要减1才能对应
