...
@Controller
@RequestMapping("/internal/brand/bookingReport")
public class BrandReportBookingController {
    ...
    public String marketingCouponReport(Model model, BookingSearchModel mBookingSearchModel) {
        ...
        return "brand_report_booking";
    }

    public Model queryShopMessage(Model model, BookingSearchModel mBookingSearchModel) throws Exception {

        List<CommercialEntity> listCommercial = mCommercialService.queryCommercialByBrandId(mBookingSearchModel.getBrandIdenty());
