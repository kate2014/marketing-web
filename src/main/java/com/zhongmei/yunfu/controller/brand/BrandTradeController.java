 ...
 */
@Controller
@RequestMapping("/internal/brand/trade")
public class BrandTradeController extends BaseController{
    ...
    public String refundquery(Model model, TradeModel mTradeModel){
        try{
            ...
            return redirect("/internal/brand/trade/tradeDetail?tradeId="+mTradeModel.getTradeId()+"&brandIdenty="+mPaymentItemEntity.getBrandIdenty()+"&shopIdenty="+mPaymentItemEntity.getShopIdenty());
        }catch (Exception e){
            e.printStackTrace();
            return "fail";
        }
